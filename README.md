...
### GitHub
```
GET https://codepeek-api.vercel.app/github/{g_handle}
```
...
### LeetCode
```
GET https://codepeek-api.vercel.app/leetcode/{lc_handle}
```
...
### Codeforces
```
GET https://codepeek-api.vercel.app/codeforces/{cf_handle}
```
...
### CodeChef
```
GET https://codepeek-api.vercel.app/codechef/{cc_handle}
```
...
### GeeksforGeeks
```
GET https://codepeek-api.vercel.app/gfg/{gfg_handle}
```
...
### HackerRank
```
GET https://codepeek-api.vercel.app/hackerrank/{hr_handle}
```
...
```bash
git clone https://github.com/shivabommera143/codepeek-api.git
cd codepeek-api
```
